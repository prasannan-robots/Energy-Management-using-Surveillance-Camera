...
protected:
  ...
  void initLED() {
    // Attach each pin to a specific channel, frequency, and resolution
ledcAttachChannel(BOARD_LED_PIN_R, BOARD_LEDC_BASE_FREQ, BOARD_LEDC_TIMER_BITS, BOARD_LEDC_CHANNEL_1);
ledcAttachChannel(BOARD_LED_PIN_G, BOARD_LEDC_BASE_FREQ, BOARD_LEDC_TIMER_BITS, BOARD_LEDC_CHANNEL_2);
ledcAttachChannel(BOARD_LED_PIN_B, BOARD_LEDC_BASE_FREQ, BOARD_LEDC_TIMER_BITS, BOARD_LEDC_CHANNEL_3);
